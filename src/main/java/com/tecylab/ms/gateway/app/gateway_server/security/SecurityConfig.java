...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authHttp->authHttp
                ...
                .requestMatchers(HttpMethod.PUT,"/api/students/{id}","/api/courses/{id}","/api/courses/{courseID}/student/{studentId}").hasAuthority("SCOPE_write")
                .requestMatchers(HttpMethod.DELETE,"/api/students/{id}","/api/courses/{id}","/api/courses/{courseId}/student/{studentId}").hasAuthority("SCOPE_write")
